...
python3 nida_dictreader.py $OUTPUT_BASE/inputs/CSP1019_DD.xlsx NIDA-CSP-1019 $OUTPUT_BASE/outputs --var-id-column "Field Name" --var-name-column "Field Label" "Attribute Name" --var-desc-column "Field Description" "Attribute Description"
...
python3 nida_dictreader.py $OUTPUT_BASE/inputs/CTO0007-Dictionary.xlsx NIDA-CTO-0007 $OUTPUT_BASE/outputs --var-id-column "FieldName" --var-name-column "Label" --var-desc-column "Description" "Describe"
python3 nida_dictreader.py $OUTPUT_BASE/inputs/CTO0008_DD.xlsx NIDA-CTO-0008 $OUTPUT_BASE/outputs --var-id-column "Field Name" --var-name-column "Label"
